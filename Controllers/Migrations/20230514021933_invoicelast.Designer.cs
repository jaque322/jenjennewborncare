...
namespace jenjennewborncare.Migrations
{
    ...
    [Migration("20230514021933_invoicelast")]
    partial class invoicelast
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("jenjennewborncare.Models.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("jenjennewborncare.Models.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("jenjennewborncare.Models.ScheduleService", b =>
                {
            ...
            modelBuilder.Entity("jenjennewborncare.Models.Invoice", b =>
                {
                    b.HasOne("jenjennewborncare.Areas.Identity.Data.User", "User")
                        .WithMany("Invoices")
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("jenjennewborncare.Models.ScheduleService", b =>
                {
                    b.HasOne("jenjennewborncare.Models.Schedule", "Schedule")
                        .WithMany("ScheduleServices")
                        .HasForeignKey("ScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("jenjennewborncare.Models.Service", "Service")
                        .WithMany("ScheduleServices")
